...
1. 类是一种抽象的概念
    ...
    义**人的身高体重**，用(String)字符串类型定义**人的性别**，但是这都只是表示的人的一部分，
    该如何去表示人这个整体呢? 就像你要说一个人学习好，你不会说他语文好、数学好、英语好，而是
    直接说他是学霸，学霸就相当于一个类，他包含了语文好、数学好、英语好等等具体的定义学霸的属
    性。类也是这样，当基础数据类型已经不足以用来定义一个事物的完整概念时，就引入类这个新的数
    据类型来。
